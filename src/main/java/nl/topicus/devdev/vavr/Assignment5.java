...
public class Assignment5
{
	 ...
	 */
	@Nonnull
	public Function1<Integer, Integer> partialApplication(@Nonnull Integer value,
			@Nonnull Function2<Integer, Integer, Integer> function)
	{
		return null;
	}
	 ...
	 */
	@Nonnull
	public Function2<Integer, Integer, Option<Integer>> makeSafe(
			@Nonnull Function2<Integer, Integer, Integer> unsafeFunction)
	{
		return null;
	}
	 ...
	 */
	@Nonnull
	public Function4<Integer, Integer, Integer, Integer, Option<Integer>> makeSafe(
			@Nonnull Function4<Integer, Integer, Integer, Integer, Integer> unsafeFunction)
	{
		return null;
	}
	 ...
	 */
	@Nonnull public <T, U, V> Function1<T, V> composition(@Nonnull Function1<T, U> first,
			@Nonnull Function1<U, V> second)
	{
		return null;
	}
	 ...
	 */
	@Nonnull public CheckedFunction1<Integer, Integer> cacheRepeatInvocations(
			@Nonnull CheckedFunction1<Integer, Integer> function)
	{
		return null;
	}
