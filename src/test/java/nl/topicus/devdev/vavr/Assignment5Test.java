...
public class Assignment5Test
{
	...
	public void grade_assignment_5_1() {
		Function1<Integer, Integer> f1 =
				assignment5.partialApplication(5, Integer::sum);
	...
	public void grade_assignment_5_2() {
		...
		Function4<Integer,Integer,Integer,Integer,Integer> unsafeMath = (a,b,c,d) -> a + b / c - d;

		Function4<Integer, Integer, Integer, Integer, Option<Integer>>
				safeMath = assignment5.makeSafe(unsafeMath);
	...
	public void grade_assignment_5_3() {
		Function4<String,Integer,String,Integer,String> uncurried = (a,b,c,d) -> a + b + c + d;
